...
export default {
  ...
  "Open": "Ouvrir",
  "Restore this Story": "Restaurer cette histoire",
  "Categories": "Catégories",
  "Story": "Histoire", // to verify
  "The item has been restored!": "L'article a été restauré!",
  "All": "Tout",
  "Search for apps, discover new field types and add functionalities to your Storyblok project.": "Recherchez des applications, découvrez de nouveaux types de champs et ajoutez des fonctionnalités à votre projet Storyblok.",
  "My apps": "Mes apps",
  "Create new app": "Créer une nouvelle app",
  "Installed": "Installé",
  "App Directory": "Répertoire des applications",
  "There are no apps in this category.": "Il n'y a aucune application dans cette catégorie.",
  "Install": "Installer",
  "Choose the space to install this app": "Choisissez l'espace pour installer cette application",
  "Can not move asset folder into folder without permissions.": "Impossible de déplacer le dossier d'actifs dans un dossier sans autorisations.",
  "Can not move asset into folder without permissions.": "Impossible de déplacer l'actif dans un dossier sans autorisations.",
  "Can not move asset away from folder without permissions.": "Impossible de déplacer l'élément hors du dossier sans autorisations.",
  "Define the new name of the folder.": "Définir le nouveau nom du dossier.",
  "Trashbin": "Poubelle",
  "Are you sure that you want to delete this folder?": "Voulez-vous vraiment supprimer ce dossier?",
  "Add": "Ajouter",
  ...
  "New folder will be created in": "Un nouveau dossier sera créé dans",
  "trial period": "Periode d'essai",
  "Can not create asset folder without permission for parent.": "Impossible de créer un dossier d'actifs sans l'autorisation du parent.",
  "Original": "Originale",
  "Done": "Terminé",
  "Cancel": "Annuler",
  "Insert": "Insérer",
  "Add Asset(s)": "Ajouter de(s) actif(s)", // to verify
  "Close": "Fermer",
  "items": "articles",
  "Delete": "Supprimer",
  ...
  "Filename (asc)": "Nome de fichier (asc)",
  "Creation date (desc)": "Creation date (desc)",
  "Filename (desc)": "Nom de fichier (desc)",
  "Last updated date (asc)": "Date de dernière mise à jour (asc)",
  "Last updated date (desc)": "Date de dernière mise à jour (desc)",
  "You are not allowed to insert this filetype here.": "Vous n'êtes pas autorisé à insérer ce type de fichier ici.",
  "This key is already defined": "Cette clé est déjà définie",
  "Key is in invalid format": "La clé est dans un format non valide",
  "Something went wrong uploading some items": "Une erreur s'est produite lors du téléchargement de certains éléments",
  "Please choose a folder in the left sidebar": "Veuillez choisir un dossier dans la barre latérale gauche",
  "Define the new name of": "Définissez le nouveau nom de",
  "Something went wrong renaming the attribute": "Une erreur s'est produite lors du changement de nom de l'attribut",
  "Be aware! Changing the name can take a few minutes to update all content items. Make sure your editors have saved their current work and exit the editor.": "Attention ! La modification du nom peut prendre quelques minutes pour mettre à jour tous les éléments de contenu. Assurez-vous que vos éditeurs ont enregistré leur travail actuel et quittez l'éditeur.",
  "Define the new name of the component group.": "Définissez le nouveau nom du groupe de composants.",
  "Save": "Enregistrer",
  "Are you sure that you want to delete this component group?": "Voulez-vous vraiment supprimer ce groupe de composants?",
  "Copy": "Copier",
  "New": "Nouveau",
  "Move to group": "Déplacer vers groupe",
  ...
  "Creation of a component failed. Maybe it already exists.": "La création d'un composant a échoué. Peut-être que cela existe déjà.",
  "Are you sure you want to DELETE this component(s)?": "Voulez-vous vraiment SUPPRIMER ce(s) composant(s)?",
  "new": "Nouveau",
  "Type to search or to create a": "Tapez pour rechercher ou créer un",
  "Create new": "Créer un nouveau",
  "block": "bloc",
  "New Component": "Nouveau Component",
  "Updated": "Mis à jour",
  "Name": "Nom",
  "Shortcuts: Esc, Control + S": "Raccourcis: Esc, Control + S",
  "Next": "Suivant",
  "Define a name": "Définir un nom",
  "Save schema": "Enregistrer le schéma",
  "Act as content type (eg. blog-post)": "Agir comme type de contenu (par exemple, article de blog)",
  "Define": "Définir",
  "Nestable": "Nestable",
  ...
  "Used in the json as component name": "Utilisé dans le json comme nom de composant",
  "Be aware! Changing the technical name can take a few minutes to update all content items. Make sure your editors have saved their current work and exit the editor.": "Attention! La modification du nom technique peut prendre quelques minutes pour mettre à jour tous les éléments de contenu. Assurez-vous que vos éditeurs ont enregistré leur travail actuel et quittez l'éditeur.",
  "Display name": "Afficher le nom",
  "Preview template": "Modèle d'aperçu",
  "Screenshot or icon": "Capture d'écran ou icône",
  "Used in the editor interface only": "Utilisé uniquement dans l'interface de l'éditeur",
  "of this setting": "de ce paramètre",
  ...
  "Examples: news_items, body, columns, title, description or call_to_action_btn": "Exemples: nouveaux_articles, corps, colonnes, titre, description ou appel_à_l'action_btn "",
  "The component has been restored!": "Le composant a été restauré!",
  "Do you really want to leave without saving your changes?": "Voulez-vous vraiment quitter sans enregistrer vos modifications?",
  "Type": "Type",
  "Beta": "Bêta",
  "Translatable": "Traduisible",
  "Allow empty paragraphs": "Autoriser les paragraphes vides",
  "Linktype": "Type de lien",
  "Rich-text as default": "Texte riche par défaut",
  "Custom type": "Type personnalisé",
  "Category": "Catégorie",
  "Section items": "Éléments de section",
  "Product": "Produit",
  "Customize toolbar": "Personnaliser la barre d'outils",
  "Toolbar items": "Éléments de la barre d'outils",
  "Source": "Source",
  "CSS class options (label/value)": "Options de classe CSS (étiquette / valeur)",
  "Datasource": "La source de données",
  "Stories": "Histoires",
  "Self": "Soi",
  "Internal datasource": "Source de données interne",
  "Recommended to be checked, as UID is required for automatic link resolving.": "Recommandé à vérifier, car l'UID est requis pour la résolution automatique des liens.",
  "Use UID instead of ID": "Utiliser l'UID au lieu de l'ID",
  "In case you have a multi-language folder structure you can add the {0} placeholder and the path will be adapted dynamically. Examples: {0}/categories/, {0}/{1}/categories/": "Si vous avez une structure de dossiers multilingue, vous pouvez ajouter l'espace réservé {0} et le chemin sera adapté dynamiquement. Exemples: {0} / categories /, {0} / {1} / categories /",
  "External JSON": "JSON externe",
  ...
  "Required": "Requis",
  "Default asset folder": "Dossier d'actifs par défaut",
  ...
  "With {level} the path will be replaced dynamically using parts of the current slug. Examples: {0}/categories/, {0}/{1}/categories/": "Avec {level} le chemin sera remplacé dynamiquement en utilisant des parties du slug courant. Exemples: {0} / categories /, {0} / {1} / categories /",
  "Restrict to folder": "Restreindre au dossier",
  "Force folder restriction": "Forcer la restriction de dossier",
  "Regex validation": "Validation regex",
  "Exclude from export": "Exclure de l'exportation",
  "export app": "exporter l'application",
  "To use with the": "À utiliser avec le",
  "Default value": "Valuer défaut",
  "Can be updated by preview window": "Peut être mis à jour par la fenêtre d'aperçu",
  "Loading...": "Chargement...",
  "Item": "Article",
  "Allow only specific components to be inserted": "Autoriser uniquement l'insertion de composants spécifiques",
  "Restrict to content types": "Restreindre aux types de contenu",
  "Keep original size": "Conserver la taille d'origine",
  "Force crop": "Forcer le recadrage",
  "Prepend https to url": "Ajouter https à l'URL",
  "Height": "Hauteur",
  "Maximum characters": "Maximum de caractères",
  "Disable time selection": "Désactiver la sélection de l'heure",
  "Description": "Déscription",
  "dimensions app": "dimensions de l'application",
  "Force overwrite by merge action": "Forcer l'écrasement par l'action de fusion",
  "Id/Slug": "Id/Slug",
  "Enable RTL (Right to left)": "Activer DAG (de droite à gauche)",
  "Autosave": "Sauvegarde automatique",
  "API Url": "URL de l'API",
  "Export": "Exporter",
  "Import/Export": "Importer/Exporter",
  "Dimensions": "Dimensions",
  "Add Dimension": "Ajouter Dimension",
  "Import": "Importer",
  "A datasource in Storyblok is a collection of key-value pairs.": "Une source de données dans Storyblok est une collection de paires clé-valeur.",
  "Datasources can be used in a schema definition of a component for single or multiple choice options. You can also access": "Les sources de données peuvent être utilisées dans une définition de schéma d'un composant pour des options à choix unique ou multiple. Vous pouvez également accéder",
  "datasource entries from the API": "Entrées de source de données de l'API",
  "to use them for labels, categories or similar.": "Pour les utiliser pour des étiquettes, des catégories ou similaires.",
  "Unsaved Changes": "Modifications non enregistrées",
  "Datasource entries": "Entrées de source de données",
  "Datasources are not included in the free plan": "Les sources de données ne sont pas incluses dans le forfait gratuit",
  "but you can try them in the": "mais vous pouvez les essayer dans le",
  "Saved": "Enregistré",
  "Select all": "Tout sélectionner",
  "The options could not be loaded.": "Les options n'ont pas pu être chargées.",
  "New Datasource": "Nouvelle source de données",
  "The following component(s) can not be pasted here": "Les composants suivants ne peuvent pas être collés ici",
  "Please save first to continue editing child components.": "Veuillez enregistrer d'abord pour continuer à modifier les composants enfants.",
  "Enabled?": "Activé?",
  "Asset manager": "Gestionnaire d'actifs",
  "Loading": "Chargement",
  "Upload new": "Importer un nouveau",
  "Your file exceeds the maximum filesize limit of": "Votre fichier dépasse la limite maximale de taille de fichier de",
  "Please reduce the size of your file.": "Veuillez réduire la taille de votre fichier.",
  "Alt text": "Texte alternatif",
  "Base64": "Base64",
  "Original Size": "Taille originale",
  "Image loading failed": "Échec du chargement de l'image",
  "Quote": "Citation",
  "Code Block": "Bloc de code",
  "Ordered List": "Liste ordonnée",
  "Headline 2": "Gros titre 2",
  "Headline 4": "Gros titre 4",
  "Headline 3": "Gros titre 3",
  "Headline 5": "Gros titre 5",
  "Paragraph": "Paragraphe",
  "Help": "Aide",
  "Internal link": "Lien internale",
  "Show only selected": "Afficher uniquement la sélection",
  "more items found": "plus d'articles trouvés",
  "Invoices": "Factures",
  "Tip: Use Ctrl + S to save": "Astuce: Utiliser Ctrl + S pour enregistrer",
  "Input": "Entré",
  "Publish": "Publier",
  "You are not allowed to edit this plugin but can see the code at Settings/Details.": "Vous n'êtes pas autorisé à modifier ce plugin, mais vous pouvez voir le code dans Paramètres / Détails.",
  ...
  "Output": "Sortie",
  "for approval to make it available for all users.": "pour approbation afin de le rendre accessible à tous les utilisateurs.",
  "Submit the plugin": "Soumettre le plugin",
  "Code": "Code",
  ...
  "Add languages the user should have access to (acts as whitelist). If no item is selected the user has rights to edit all content.": "Add languages the user should have access to (acts as whitelist). If no item is selected the user has rights to edit all content.",
  "Deny changing the slug of a story": "Deny changing the slug of a story",
  "Add folders or content items the user should have access to (acts as whitelist). If no item is selected the user has rights to edit all content.": "Add folders or content items the user should have access to (acts as whitelist). If no item is selected the user has rights to edit all content.",
  ...
  "Add datasources the user should have access to (acts as whitelist). If no item is selected the user has rights to edit all datasources.": "Add datasources the user should have access to (acts as whitelist). If no item is selected the user has rights to edit all datasources.",
  ...
  "Invite others": "Inviter les autres",
  "yet.": "encore.",
  "Send": "Envoyé",
  "Done!": "Terminé!",
  ...
  " is not a valid email": " email n'est pas valide",
  "from": "de",
  "Target": "Target",
  "Asset": "Asset",
  ...
  "Help other collaborators to identify you better by providing your name and a profile picture.": "Aidez d'autres collaborateurs à mieux vous identifier en fournissant votre nom et une photo de profil.",
  "Are you sure you want to delete this item(s)?": "Voulez-vous vraiment supprimer ce ou ces articles?"
}
